...
def create_weekly_view_sql():
    conn = sqlite3.connect(r'C:\Users\RHODA\LabExercise3\Data-Pipelines-Exercise\database\merged.db')
...
ct_load_database >> ct_fix_name_formats >> ct_remove_invalid_dates >> ct_remove_duplicates >> bst_load_database >> bst_fix_branch_service_format >> bst_fix_price_format >> bst_remove_duplicates >> m_merged_data_frames >> m_remove_duplicate_txn_id >> m_add_age_column >> m_ingest_to_database >> m_create_weekly_view >> create_weekly_view_sql
