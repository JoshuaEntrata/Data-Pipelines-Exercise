...
print("")
df_customer_transaction = pd.read_parquet("D:\Github\School Projects\Data Warehousing Class\LabExercise3\parquet\customer_transaction\customer_txn_load_database.parquet")
